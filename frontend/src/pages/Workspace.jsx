...
import {
  Plane, Plus, MessageSquare, Trash2, LogOut, ChevronDown, PanelRightClose, PanelRightOpen, KeyRound, Zap, Settings,
} from "lucide-react";
      ...
      <aside className="w-64 border-r border-border flex flex-col shrink-0">
        ...
        <div className="border-t border-border p-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button data-testid="account-settings-btn" onClick={() => navigate("/settings")} title="Account settings" className="text-muted-foreground hover:text-primary transition-colors p-1">
